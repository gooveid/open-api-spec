...
export class AuthApi extends runtime.BaseAPI {
     ...
     * Make google login
     */
    async authGooglePostRaw(requestParameters: AuthGooglePostRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<LoginResponse>> {
     ...
     * Make google login
     */
    async authGooglePost(requestParameters: AuthGooglePostRequest, initOverrides?: RequestInit): Promise<LoginResponse> {
     ...
     * Logout
     */
    async authLogoutPostRaw(initOverrides?: RequestInit): Promise<runtime.ApiResponse<void>> {
        const queryParameters: any = {};
     ...
     * Logout
     */
    async authLogoutPost(initOverrides?: RequestInit): Promise<void> {
